...
export const SOCIAL_LINKS: SocialLink[] = [
    ...
    {
        label: "LinkedIn",
        href: "https://www.linkedin.com/in/pranshu-3421251b8/",
        icon: "FiLinkedIn",
    },
    {
        label: "Twitter",
        href: "https://x.com/sharmapranshu17",
        icon: "FiTwitter",
    },
    {
        label: "Instagram",
        href: "https://instagram.com/pranshu_Sharma17",
        icon: "FiInstagram",
    },
    {
        label: "Email",
        href: "mailto:sharma.pranshu1706@gmail.com",
        icon: "FiMail",
    },
];
...
export const SITE_CONFIG: SiteConfig = {
    title: "pranshu_Sharma",
    description:
        "Final-year MCA student and Full Stack Developer specializing in Java, Spring Boot & React. Open to internships and full-time opportunities.",
    url:
