...
const EDUCATION: EducationEntry[] = [
    {
        institution: "Raja Balwant Singh Management Technical Campus - AKTU",
        degree: "Master of Computer Applications (MCA)",
        period: "2024 – 2026",
        location: "Greater Agra, India",
        coursework: ["Data Structures", "Algorithms", "DBMS", "OS", "Software Engineering"],
    },
    {
        institution: "Dr. MPS Memorial College of Business Studies",
        degree: "Bachelor of Computer Applications (BCA)",
        period: "2021 - 2024",
        location: "Greater Agra, India",
        coursework: ["OOPS", "Web Development","Programming in C", "Java", "C++"],
    },
];
