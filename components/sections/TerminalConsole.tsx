    ...
    const [history, setHistory] = useState<CommandHistory[]>([
        {
            ...
            output: (
                <div className="space-y-1 text-amber-500 font-mono text-[11px] md:text-xs">
                    <div>[OK] Initializing pranshu.sys core modules...</div>
                    <div>[OK] Loading Technical Skills Topology Layer...</div>
                    <div>[OK] Syncing LeetCode metric controllers... </div>
    ...
    const handleCommand = (cmd: string) => {
        ...
        switch (trimmed) {
            ...
            case "about":
                output = (
                    <div className="space-y-2 text-muted-foreground font-mono text-[11px] md:text-xs leading-relaxed">
                        <p>
                            <span className="text-foreground font-bold">Pranshu Sharma </span> is a Systems and Backend Software Engineer in his final year of MCA at RBSMTC College (2024-2026).
                        </p>
                        <p>
            ...
            case "skills":
                output = (
                    <div className="space-y-2 text-muted-foreground font-mono text-[11px] md:text-xs">
                        <div><span className="text-amber-500 font-bold">[Layer 01] Frontend Ingress:</span> React, Tailwind CSS, TypeScript</div>
                        <div><span className="text-amber-500 font-bold">[Layer 02] Security Gate:</span> Spring Security, JWT, OAuth 2.0</div>
                        <div><span className="text-amber-500 font-bold">[Layer 03] Backend Engine:</span> Java, Spring Boot, JPA, Hibernate</div>
            ...
            case "projects":
                output = (
                    <div className="space-y-3 text-muted-foreground font-mono text-[11px] md:text-xs">
                        ...
                        <div>
                            <span className="text-amber-500 font-bold">SMART EMAIL ASSISTANT</span> - EMAIL Suggestions in Browser (Java, Spring Boot, React)
                            <br />
            ...
            case "certs":
                output = (
                    <div className="space-y-2 text-muted-foreground font-mono text-[11px] md:text-xs">
                        <div>• <span className="text-amber-500 font-bold">FULL STACK DEVELOPMENT TRAINING</span> (FLIKT TECHNOLOGY WEB SOLUTIONS)</div>
                        <div>• <span className="text-amber-500 font-bold">Frontend Development Certificate</span> (IBM Skills Build)</div>
                    </div>
                );
                break;
...
{`   ██████╗  ██████╗
   ...
   ╚═╝      ╚═╝  ╚═╝`}
                        ...
                        <div className="space-y-1 text-muted-foreground">
                            <div><span className="text-amber-500 font-bold">guest@pranshu.sys</span></div>
                            <div>--------------------</div>
                            <div><span className="text-amber-500 font-bold">OS:</span> PranshuOS v1.0.0 (Darwin arm64)</div>
                            <div><span className="text-amber-500 font-bold">Host:</span> MCA Final Year</div>
            ...
            case "contact":
                output = (
                    <div className="space-y-1 text-muted-foreground font-mono text-[11px] md:text-xs">
                        <div><span className="text-amber-500 font-bold">Email:</span> sharma.pranshu1706@gmail.com</div>
                        <div><span className="text-amber-500 font-bold">Github:</span> github.com/sharmapranshu1706</div>
                        <div><span className="text-amber-500 font-bold">LinkedIn:</span> linkedin.com/in/pranshu-3421251b8</div>
                    </div>
                );
                break;
            ...
            <div className="max-w-5xl mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-muted-foreground max-w-2xl text-base leading-relaxed">
                        Query Pranshu&apos;s developer parameters, stack topology, and core project specifications directly from a live interactive terminal gateway.
                    </p>
                </motion.div>
                            ...
                            <div key={index} className="space-y-1.5">
                                {item.command !== "system-init" && (
                                    <div className="flex items-center gap-2 text-foreground font-bold">
                                        <span className="text-amber-500">guest@pranshu.sys:~$</span>
