            ...
            <div className="max-w-5xl mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                        Curious about what happens behind the scenes when code runs—from application architecture and system design to runtime behavior, databases, and distributed systems..
                    </p>
                </motion.div>
